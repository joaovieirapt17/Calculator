...
HD_PWD='C:/Users/Utilizador/Desktop/calculadora/calculadora_final/calculadora_final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log calculadora.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source calculadora.tcl
