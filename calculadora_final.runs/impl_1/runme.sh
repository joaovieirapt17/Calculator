...
HD_PWD='C:/Users/Utilizador/Desktop/calculadora/calculadora_final/calculadora_final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log calculadora.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source calculadora.tcl -notrace
